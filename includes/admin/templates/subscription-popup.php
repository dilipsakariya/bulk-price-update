...
?>
<div class="bpu-subscription-modal-wrapper">
	<div class="bpu-subscription-modal-overlay"></div>
	<div class="bpu-subscription-modal">
		<div class="bpu-subscription-modal-main">
			...
			<form method="POST" class="bpu-subscription-form">
				...
				<div class="bpu-subscription-actions">
					<a href="#" class="bpu-subscription-skip"><?php esc_html_e( 'Cancel', 'bulk-price-update' ); ?></a>
					<button class="button-primary"><?php esc_html_e( 'Subscribe', 'bulk-price-update' ); ?></button>
				</div>
			</form>
		</div>

		<p class="bpu-subscription-modal-thanks" style="display: none;"><?php esc_html_e( 'Thank you for signing up to our Newsletter!', 'bulk-price-update' ); ?></p>
